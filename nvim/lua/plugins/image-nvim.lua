...
--
-- Filename: ~/.config/nvim/lua/plugins/image-nvim.lua
  ...
  },
  {
    ...
    config = function()
      require("image").setup({
        ...
        -- Debug logging: enabled temporarily to troubleshoot rendering
        -- Set enabled = false once images render correctly
        debug = {
          enabled = true,
